...
namespace QuizzApp.Data.Repositories
{
    public class QuizAppGenericRepository<TEntity> : IQuizAppGenericRepository<TEntity> where TEntity : class
    {
        ...
        public QuizAppGenericRepository(ApplicationDbContext dbContext)
        {
            DbContext = dbContext;
